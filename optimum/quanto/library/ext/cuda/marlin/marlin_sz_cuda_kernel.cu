// From: https://github.com/shcho1118/marlin-scaled-zero-point/blob/feat/scaled-zero-point/marlin/marlin_sz_cuda_kernel.cu
...
#define CALL_IF(THREAD_M_BLOCKS, THREAD_N_BLOCKS, THREAD_K_BLOCKS, GROUP_BLOCKS) \
    ...
    cudaFuncSetAttribute( \
      MarlinSZ<THREADS, THREAD_M_BLOCKS, THREAD_N_BLOCKS, THREAD_K_BLOCKS, STAGES, GROUP_BLOCKS>, \
